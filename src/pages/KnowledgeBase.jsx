...
export default function KnowledgeBase() {
  ...
  const bestDecisions = [...knowledgeData]
    .filter(k => k.card_played && k.reward > 0.5 && k.was_successful)
    .sort((a, b) => b.reward - a.reward)
    .slice(0, 10);
  
  const displayBest = bestDecisions;
          ...
          <Button 
            onClick={async () => {
              ...
              try {
                ...
                alert('✅ Successfully added 500K records! AI is now WORLD CHAMPION level!');
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
          <Card className="bg-gradient-to-br from-purple-900/40 to-purple-800/30 border-purple-700/50">
            <CardContent className="p-6">
              ...
              <div className="text-3xl font-bold text-white mb-1">
                {currentData?.aha_score?.toLocaleString() || 0}
              </div>
          ...
          <Card className="bg-gradient-to-br from-emerald-900/40 to-emerald-800/30 border-emerald-700/50">
            <CardContent className="p-6">
              ...
              <div className="text-3xl font-bold text-white mb-1">
                {currentData?.games_played?.toLocaleString() || 0}
              </div>
